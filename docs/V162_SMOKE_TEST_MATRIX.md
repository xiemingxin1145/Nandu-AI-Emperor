...
3. COURT-001 全部 54 张正式素材、应天府专属图、51 条 H.264/yuv420p/无内嵌音轨视频、6 条序章旁白继续由双 CI 和 APK 拆包逐项校验。
   ...
   `DELEGATION-INTEGRATION-001` 选择性整合 Claude PR #64，并补足朝议长期授权、真实人口/钱粮、开局无军团募兵、人物位置、禁战/撤销/亲令覆盖、存档日志与真实地图回放；Android Build #245 / Debug APK #755 实证 **194/194** JVM 单测全过，APK 视频 **51/51**、朝堂 **54/54**、地图图标 **16/16**、旁白 **6/6**、BGM 候选 **8/8**；仍须玩家手机验收。
