...
| COURT-02 | 朝会议政 | 底部“朝议” | 已进入游戏 | `EmperorMainScreen`；真实 `GameState`、前景正式官员、臣议点选/综合、朱批前命令与风险预览 | 没有可见名臣时可显示合规普通朝官，不得造 Officer | 底部五标签；“朕再修改”返回圣意输入并保留前议 | `AUTO`：54 张素材、臣议单选/多选/综合、澄清禁批、内部 ID 中文化 | 实际点选臣议、综合诸议、补充圣意、朱批准行；岳飞、秦桧、吴玠不错误实体出席 | `DEVICE_REQUIRED` |
