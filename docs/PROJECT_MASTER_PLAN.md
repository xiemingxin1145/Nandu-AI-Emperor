...
状态：`DONE`（Codex Work；选择性接入 Claude PR #64；首轮 Android Build #245 / Debug APK #755 已通过；正式 STAB-007 仍为 `IN_PROGRESS`）
...
额外修正：补齐此前从未写入的授权执行日志；募兵核对真实人口、当地守军、人物所在、国库钱粮与授权预算；宗泽无直属军团时可依法就地募兵成军，并取消与新圣旨冲突的旧历史瞬移。
自动覆盖：**Android Build #245 PASS；Debug APK #755 PASS；194/194 JVM 单测真实执行，0 失败、0 异常、0 跳过**（较 WORLD-UX-001 的 163 项新增 **31**）；APK 视频 **51/51 H.264 + yuv420p + 0 音轨**，朝堂 **54/54**，地图图标 **16/16**，四季视频/CG 各 **4/4**，旁白 **6/6**，BGM 候选 **8/8**，固定开发签名一致。
...
- **Android Build #245 / Debug APK #755** 双 CI 实证 **194/194** JVM 回归全部运行、0 失败、0 异常、0 跳过；实际 APK 拆包确认视频 **51/51 H.264/yuv420p/无音轨**、朝堂图 **54/54**、地图图标 **16/16**、四季视频/CG 各 **4/4**、旁白 **6/6**、BGM 候选 **8/8**；固定测试签名和 V1.6.1/versionCode 28 未改变。
